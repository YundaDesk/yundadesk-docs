...
1. Open **AI Agents**, select the relevant Agent, and open **Human handoff** settings.
...
5. Members with AI customer service management permission can use “Reception settings” below a notice to open the originating Agent's settings. Historical notices without an associated Agent do not show this link.
...
These customer notices apply only to AI-to-human handoff. Ordinary human assignment or transfer does not send additional handoff copy. Assignment system records remain visible in the workspace, even when customer notices are disabled.
