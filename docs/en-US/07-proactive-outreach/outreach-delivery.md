...
Common reasons for no send include missing event data, an active cooldown, quiet hours, an unavailable channel identity, pending human confirmation, or channel delivery failure.
