...
The current bilingual release contains 76 customer articles per locale. It covers onboarding, channels, the Inbox, AI customer service, knowledge and learning, Yuna, proactive outreach, customers and teams, reporting and billing, troubleshooting, apps and integrations, and security boundaries.
